...
export default class Chasis extends Component {
  constructor(props) {
    super(props)
    this.state = {
      fotoUp: false,
      ...
      imagePath: '',
      imagenUri: '',
      imageRef: require('../assets/fotoRef/obg-10.jpg'),
      ideaOP: true,
      btnEstado: true,
      imageHeight: height,
      imageWidth: width,
            ...
            <View style={{flex:1, backgroundColor:'white', height: width*0.85, width: height*0.65, position: 'absolute'}}>
               ...
               <View style={{flex:0.2, backgroundColor: 'white', flexDirection: 'row', paddingHorizontal: 10, paddingBottom: height * 0.05}}>
                  <View style={{flex:1, flexDirection: 'row', justifyContent: 'flex-end', backgroundColor: 'white', alignItems: 'center'}}>
                    ...
                    {this.state.fotoUp ? <Text style={{textAlign: 'center'}}>Ver Referencia</Text> : <Text style={{textAlign: 'center'}}></Text>}
                    ...
                    <View style={styles.containerModal}>
                      <View style={styles.bordeModal}>
                        <View style={{flex:1}}>
                          ...
                          <Image resizeMode='contain' style={{flex:1, height: null, width: null, alignItems:'center', justifyContent:'center'}} source={require('../assets/fotoRef/obg-10.jpg')} />
