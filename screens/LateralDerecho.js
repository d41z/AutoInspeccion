...
export default class LateralDerecho extends Component {
  constructor(props) {
    super(props)
    this.state = {
      fotoUp: false,
      ...
      imagePath: '',
      imagenUri: '',
      imageRef: require('../assets/fotoRef/obg-4.jpg'),
      ideaOP: true,
      btnEstado: true,
      imageHeight: height,
      imageWidth: width,
                    ...
                    <View style={styles.containerModal}>
                      <View style={styles.bordeModal}>
                        <View style={{flex:1}}>
                          ...
                          <Image resizeMode='contain' style={{flex:1, height: null, width: null, alignItems:'center', justifyContent:'center'}} source={require('../assets/fotoRef/obg-4.jpg')} />
