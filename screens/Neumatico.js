...
export default class Neumatico extends Component {
  constructor(props) {
    super(props)
    this.state = {
      fotoUp: false,
            ...
            <View style={{flex:0.05}}>
             ...
             <View style={styles.Body2}>
                 <View style={{flex: 1, backgroundColor: 'white', borderRadius: 10, paddingVertical: 10, alignItems: 'center', paddingHorizontal: 10}}>
                     <Text style={{textAlign: 'center', fontFamily: 'FiraSans-Black', color: 'black'}}>Llanta y neumático</Text>
                     <View style={{flex:1, paddingHorizontal: 10, paddingTop:5}}>
                         <Text style={{fontFamily: 'FiraSans-Regular', color: 'black'}}>Deben verse la rueda completa (llanta y neumaticó).</Text>
                         <Text style={{fontFamily: 'FiraSans-Regular', color: 'black'}}>Basta con fotografíar una rueda.</Text>
                     </View>
                     <TouchableWithoutFeedback
                         onPress={() => this.props.navigation.navigate('parabrisa')}
                          ...
                          <View style={styles.headerModel}>
                            <Image source={require('../assets/modal/icono-ayuda.png')} style={styles.flecha} />
                              <View style={{flex: 1, paddingLeft: height * 0.015}}>
                                ...
                                <Text></Text>
                                <Text style={{fontFamily: 'FiraSans-Black', color: 'black', fontSize: 18}}>LLANTA Y NEUMÁTICO</Text>
                              </View>
                              <View style={{flex: 0.2}}>
                            ...
                            <ScrollView contentContainerStyle={styles.contentContainer}>
                              <View style={{flex:1, alignItems: 'center'}}>
                                <Text style={{fontFamily: 'FiraSans-Regular', color: 'black'}}>
                                  Basta con fotografiar sólo una rueda del vehículo.
                    ...
                    <View style={styles.containerModal}>
                      <View style={styles.bordeModal}>
                        <View style={{flex:1}}>
                          ...
                          <Image resizeMode='contain' style={{flex:1, height: null, width: null, alignItems:'center', justifyContent:'center'}} source={require('../assets/fotoRef/obg-12.jpg')} />
