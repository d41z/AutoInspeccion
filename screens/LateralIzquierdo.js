...
export default class LateralIzquierdo extends Component {
  constructor(props) {
    super(props)
    this.state = {
      fotoUp: false,
         ...
         <View style={{flex: 1, backgroundColor:'transparent', flexDirection: 'row'}}>
            ...
            <View style={styles.Body2}>
              <View style={{flex: 1, backgroundColor: 'white', borderRadius: 10, paddingVertical: 10, alignItems: 'center', paddingHorizontal: 10}}>
                <Text style={{textAlign: 'center', fontFamily: 'FiraSans-Black', color: 'black'}}>Lateral Izquierda</Text>
                          ...
                          <View style={styles.headerModel}>
                            <Image source={require('../assets/modal/icono-ayuda.png')} style={styles.flecha} />
                              <View style={{flex: 1, paddingLeft: height * 0.015}}>
                                ...
                                <Text></Text>
                                <Text style={{fontFamily: 'FiraSans-Black', color: 'black', fontSize: 18}}>LATERAL IZQUIERDA</Text>
                              </View>
                              <View style={{flex: 0.2}}>
                    ...
                    <View style={styles.containerModal}>
                      <View style={styles.bordeModal}>
                        <View style={{flex:1}}>
                          ...
                          <Image resizeMode='contain' style={{flex:1, height: null, width: null, alignItems:'center', justifyContent:'center'}} source={require('../assets/fotoRef/obg-6.jpg')} />
