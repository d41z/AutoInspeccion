...
export default class DamagedScreen extends Component {
  constructor(props) {
    super(props)
    this.state = {
      disabledButton: true,
          ...
          style={styles.fondoBody}> 
            <View style={styles.Body}>
                <View style={{flex:1, alignItems:'center', paddingHorizontal: width * 0.05, paddingVertical: height * 0.05}}>
                  ...
                  ¿El automóvil tiene daños?
                  </Text>
                  <Text style={{textAlign: 'center', fontFamily: 'FiraSans-Regular', color: 'black', paddingTop: height * 0.015}}>
                  Recuerde que es deber del asegurado declarar todos los daños del vehículo, en caso de existir.
                  </Text>
