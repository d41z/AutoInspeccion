...
export default class DaFrontalScreen extends Component {
    constructor(props) {
        ...
        if(props.navigation.state.params.frontal.listo === true){
            console.log('sdsdsdsdsdsdsdsdsdsdsdsdsdsdsd')
            ...
            this.state = {
                ...
                date: '',
                posteriorDa: {
                    listo: this.props.navigation.state.params.frontal.listo,
                    pdelantera: false,
                    ptrasera: false,
                    chapaM: false,
                    tapaDelantera: false,
    ...
    methodGoTo = (props) => {
        ...
        let posterior = props.navigation.state.params.frontal
        ...
        var aux6 = false
        var aux6 = posterior.parachoque
        console.log('holandaaaaaaaaaa')
        console.log(posterior.imagen)
    ...
    openImagePicker6(){
        ...
        ImagePicker.launchCamera(options, (response) => {
            if(response.didCancel){
                ...
                let posteriorDa = Object.assign({}, this.state.posteriorDa);
                posteriorDa.listo = true
                posteriorDa.parachoque = true
                posteriorDa.imagen6 = { uri: response.uri }
    ...
    nextScreen(){
        ...
        console.log('......................')
        this.props.navigation.navigate('daSelectionScreen', {item: 'DaFrontalScreen', frontal:this.state.posteriorDa})
            ...
            <View style={styles.container}>
                ...
                <View style={{flex: 1, backgroundColor:'white'}}>
                    <View style={{flex:1, alignItems:'center'}}>
                        ...
                        <View style={{flexDirection: 'row'}}>
                            ...
                            <TouchableWithoutFeedback
                                onPress={() => this.setState({ openModalImg6: true })}>
                                {this.state.fotoUp6 ? <Image  source={require('../assets/images/fotos-obligatorias/ic-verfoto.png')} style={styles.icVerFoto}/> : <View></View>}
                            </TouchableWithoutFeedback>
                ...
                >
                  <View style={styles.modalConfirmationInstru}>
                    ...
                    <Modal
                        visible={this.state.openModalImg6}
                        transparent={true}
                        animationType={'slide'}
                        onRequestClose={() => this.setState({ openModalImg6: false })}
                        supportedOrientations={['landscape']}
                    >
                        <View style={styles.modalConfirmation}>
                            <View style={styles.containerModal}>
                                <View style={styles.bordeModal}>
                                    <View style={{flex:1}}>
                                        <Image resizeMode='contain' style={{flex:1, height: null, width: null,
                                            alignItems:'center', justifyContent:'center'}} source={this.state.posteriorDa.imagen6} />
                                    </View>
                                ...
                                <TouchableWithoutFeedback onPress={() => this.setState({ openModalImg6: false })}>
                                    <Image source={require('../assets/modal/bt-cerrar.png')}
                                           style={styles.btnCerrarModal} />
                                </TouchableWithoutFeedback>
                            </View>
