...
export default class DaLateralDScreen extends Component {
    constructor(props) {
        super(props)
        ...
        if(props.navigation.state.params.lderecho.listo === true){
            ...
            this.state = {
                ...
                date: '',
                posteriorDa: {
                    listo: this.props.navigation.state.params.lderecho.listo,
                    pdelantera: false,
                    ptrasera: false,
                    chapaM: false,
                    tapaDelantera: false,
    ...
    methodGoTo = (props) => {
        ...
        let posterior = props.navigation.state.params.lderecho
    ...
    nextScreen(){
        ...
        console.log('......................')
        this.props.navigation.navigate('daSelectionScreen', {item: 'DaLateralDScreen', lderecho:this.state.posteriorDa})
